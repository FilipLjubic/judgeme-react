...
| `judge-me-happy-customers`                       | docs  | Official Happy Customers plan, placement, app-embed requirement, and new/legacy version behavior                      |
| `judge-me-happy-customers-customization`         | docs  | Official new Happy Customers upgrade, settings, layout, content, AI, and Vintage-theme contract                       |
...
Query the exact new Review Widget report:

```sh
ctx query \
  "How does the exact new Review Widget fetch, initialize, preview, and clean up in Hydrogen?" \
  --label review-widget-v3-spike-2026-07-14 \
  --kind notes \
  --cwd /Users/panda/Code/judgeme-react
```
...
Query the Happy Customers report:
