...
The package is prepared as an ESM-only, MIT-licensed stable 1.0 release. The first registry publish remains an owner action because npm authentication and package-name ownership must be verified interactively.
